...
const FilmDetailsSection = ({ data, openSearcherPage }) => (
    <div className="search-section">
        ...
        <div className="film-details-section">
            ...
            <div>
                <div>
                    <span className="film-details-section__title">{data.title}</span>
                    <span className="film-details-section__rating">{data.vote_average}</span>
                </div>
                <div className="film-details-section__release-duration">
